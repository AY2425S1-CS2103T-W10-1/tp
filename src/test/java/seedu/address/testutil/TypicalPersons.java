...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withRemark("She is a very hardworking student")
            .build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            ...
            .withRemark("He is a very hardworking student")
            .build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withStudentId("A0100000P")
            .withEmail("e1234467@u.nus.edu").withMajor("Business").withYear("3")
            .withComment("He is a very hardworking student").build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withStudentId("A0005000P")
            .withEmail("e1234667@u.nus.edu").withMajor("English Literature").withYear("5")
            .withRemark("He is a very hardworking student").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withStudentId("A0004000P")
            .withEmail("e1234557@u.nus.edu").withMajor("China Studies").withYear("2")
            .withComment("She is a very hardworking student").withRemark("She is a very hardworking student")
            .build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withStudentId("A0200000P")
            ...
            .withRemark("She is a very hardworking student").withComment("She is a very hardworking student")
            .build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withStudentId("A1000000P")
            .withEmail("e1134567@u.nus.edu").withMajor("Religious Studies").withYear("1")
            .withRemark("He is a very hardworking student").withComment("He is a very hardworking student")
            .build();

    // Manually added
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withStudentId("A1030000P")
            .withEmail("e2134567@u.nus.edu").withMajor("Data Science").withYear("1")
            .withRemark("He is a very hardworking student").withComment("He is a very hardworking student")
            .build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withStudentId("A1000000R")
            .withEmail("e1114567@u.nus.edu").withMajor("Pharmaceutical Science").withYear("3")
            .withRemark("She is a very hardworking student").withComment("She is a very hardworking student")
            .build();
