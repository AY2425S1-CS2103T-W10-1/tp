    ...
    public static Person[] getSamplePersons() {
        ...
        return new Person[] {
            ...
            new Person(new Name("Roy Balakrishnan"), new StudentId("A9262441K"), new Email("e5739264@u.nus.edu"),
                ...
                getTagSet("colleagues"), new Year("1"), EMPTY_REMARK)
        };
    }
